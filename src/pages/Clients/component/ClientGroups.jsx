...
const ClientGroups = () => {
  return (
    <div>
     <div className="client-groups-container">
                <h4 style={{marginBottom:"25px"}}><i className="sicon-group mx-3" style={{fontSize:"25px"}}></i>مجموعات العملاء <span>(2 مجموعات)</span></h4>
