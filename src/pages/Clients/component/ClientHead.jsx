        ...
        <div>
            <div className="header-container-client-head">
                ...
                <div className="header-right-client bg-none">
                    <Button className="btn-add-client" style={{ backgroundColor: "white" , border:"1px solid blue"}}>
                ...
                <div className="header-left">
                    <Button className="btn-services-client" onClick={handleShowFilterModal}>
                        <i className="sicon-filter icon-filter"></i>  تصفية
                    </Button>
                    <Button className="btn-services-client" onClick={handleShowServiceModal}>
                    ...
                    <div style={{ textAlign: "center" }}>
                        ...
                        <div>
                            ...
                            <div className="customer-search-container">
                                <input type="text" className="customer-search-input" placeholder="ابحث عن ما تريد" style={{marginBottom:"20px"}} />
