...
import { IoExtensionPuzzleOutline, IoInfinite, IoPeopleSharp, IoStorefrontOutline } from 'react-icons/io5'
...
export default function Marketplace({ darkMode, setDarkMode }) {
    return <>
        ...
        >
            ...
            >
                <HeaderComponent label=" باقة المتجر " />
                <div className=" w-full">
                    <div className="flex flex-row justify-center items-center p-2 border rounded-md w-[80%]  m-auto my-4">
                        <div className="flex flex-col items-center gap-2 border-e-2 p-6 w-full">
                            ...
                            <h2>سلة سبيشال </h2>
                            <p className=''>الباقة المثالية لإدارة نمو متجرك من خلال أدوات الربط والتكامل</p>
                        </div>
                        ...
                        <body className='flex flex-col ga-2 '>
                            <div className="flex flex-row justify-between items-center  border-b-2">
                                <div className="flex flex-row gap-2 items-center p-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className='text-sm'>أضِف جميع فروعك وأظهرها لعملائك عبر إضافة عدد غير محدود من فروع متجرك</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-row justify-between items-center  border-b-2">
                                <div className="flex flex-row gap-2 items-center p-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className='text-sm'>أضِف طاقم عملك لإدارة متجرك بشكل متكامل من خلال إضافة الموظفين </p>
                                    </div>
                                </div>
                                <div className="flex flex-row items-center justify-between border rounded-md me-2">
                                    <h5>عدد لا محدود</h5>
                            ...
                            <div className="flex flex-row justify-between items-center  border-b-2">
                                <div className="flex flex-row gap-2 items-center p-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className='text-sm'>أضِف رصيداً من عدد الأحرف لترجمة متجرك فورياً بأكثر من 40 لغة.</p>
                                    </div>
                                </div>
                                <div className="flex flex-row items-center justify-between border rounded-md me-2 ">
                            ...
                            <div className="flex flex-row justify-between items-center  border-b-2">
                                <div className="flex flex-row gap-2 items-center p-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <h4>رصيد واتساب</h4>
                                        <p className='text-sm'>انطلق لتنشيط مبيعاتك عبر إرسال الحملات التسويقية و العروض إلى عملائك.</p>
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-row justify-between items-center  border-b-2 ">
                            <div className="flex flex-row gap-2 items-center p-3">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className='text-sm'>ادعم أحبابك في تجارتهم الإلكترونية بإهدائهم بطاقة سلة للاشتراك في أحد الباقات الشهرية أو السنوية</p>
                                </div>
                            </div>
