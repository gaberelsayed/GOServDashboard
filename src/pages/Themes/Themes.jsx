            ...
            >
                <div className="border rounded-md overflow-hidden gap-2 mb-10 bg-blue-300 flex flow-row items-center ">
                    ...
                    <p className='text-blue-700'>
                        مساهماتك بتقييم تجربتك تساعد الآخرين على اتخاذ قرارات بشأن الثيمات التي تساعدهم بإدارة متاجرهم
                        <span>
                            <button className='underline text-blue-900'>اضغط هنا للتقييم</button>
                        </span></p>
                </div>
                    ...
                    <div className="my-6">
                        ...
                        <div className="themes rounded-md overflow-hidden my-10">
                            <header className='bg-gray-100 p-3 flex flex-row items-center  justify-between'>
                                ...
                                <div className="flex flex-row ">
                                    ...
                                    <button className='text-black hover:bg-green-400 border outline-1 rounded-md px-2 py-1'>عرض المزيد</button>
                                </div>
                            </header>
                            <body className='flex xl:flex-row flex-col gap-3 items-center my-6'>
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    {/* كمل هنا */}
                                    <img class="w-full " src="https://salla-dev-portal.s3.eu-central-1.amazonaws.com/uploads/o5cqTdwQWor238cxkgv455wRDvnttwGn80wy6aee.png" alt="Sunset in the mountains" />
                                    <div class="px-6 py-4">
                                        <div className="flex flex-row justify-between items-center">
                                            <div className="flex flex-row items-center gap-2">
                                                ...
                                                <h4>وسام</h4>
                                                <p className='bg-green-800 rounded-pill px-1 text-white'>1269.0</p>
                                            </div>
                                        ...
                                        <div className="flex flex-row justify-between items-center">
                                            ...
                                            <button className='underline text-black text-sm'>تقييم الثيم</button>
                                        </div>
                        ...
                        <div className="themes rounded-md overflow-hidden my-10">
                            ...
                            <body className='flex xl:flex-row flex-col gap-3 items-center my-6'>
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    {/* كمل هنا */}
                                    <img class="w-full " src="https://salla-dev-portal.s3.eu-central-1.amazonaws.com/uploads/1Ho12lAQ15qhnbWRHOCIxREPEZq4DB8Zs6cGMPY8.png" alt="Sunset in the mountains" />
                                    <div class="px-6 py-4">
                                        <div className="flex flex-row justify-between items-center">
                                            <div className="flex flex-row items-center gap-2">
                                                <h4>عطاء</h4>
                                ...
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    {/* كمل هنا */}
                                    <img class="w-full " src="https://salla-dev-portal.s3.eu-central-1.amazonaws.com/uploads/gu6pgCKzzVWnODBGIM4UjQupyk07dmE1IcWip9pT.png" alt="Sunset in the mountains" />
                                    <div class="px-6 py-4">
                                        <div className="flex flex-row justify-between items-center">
                                            <div className="flex flex-row items-center gap-2">
                                ...
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    {/* كمل هنا */}
                                    <img class="w-full " src="https://salla-dev-portal.s3.eu-central-1.amazonaws.com/uploads/oiPJlMF7qh6Wf0S744rQUwfUqFTaiONG7RJKmDMs.jpg" alt="Sunset in the mountains" />
                                    <div class="px-6 py-4">
                                        <div className="flex flex-row justify-between items-center">
                                            <div className="flex flex-row items-center gap-2">
